...
export class CompanyFilesArgs {
  ...
  distinct?: Array<"id" | "name" | "date" | "companyId" | "processed" | "movementsProcessed" | "creditsProcessed" | "debitsProcessed" | "fileType" | "updatedAt" | "createdAt"> | undefined;
}
