...
import { DebitsUpdateManyWithoutReceiptNestedInput } from "../inputs/DebitsUpdateManyWithoutReceiptNestedInput";
import { EnumFileTypesFieldUpdateOperationsInput } from "../inputs/EnumFileTypesFieldUpdateOperationsInput";
import { StringFieldUpdateOperationsInput } from "../inputs/StringFieldUpdateOperationsInput";

@TypeGraphQL.InputType("FileUpdateWithoutMovementsInput", {
  isAbstract: true
})
export class FileUpdateWithoutMovementsInput {
  ...
  @TypeGraphQL.Field(_type => DebitsUpdateManyWithoutReceiptNestedInput, {
    nullable: true
  })
  debits?: DebitsUpdateManyWithoutReceiptNestedInput | undefined;
