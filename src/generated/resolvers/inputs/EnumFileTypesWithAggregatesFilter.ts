...
import { NestedEnumFileTypesWithAggregatesFilter } from "../inputs/NestedEnumFileTypesWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { FileTypes } from "../../enums/FileTypes";

@TypeGraphQL.InputType("EnumFileTypesWithAggregatesFilter", {
  isAbstract: true
})
export class EnumFileTypesWithAggregatesFilter {
